...
class MyNotes {
  ...
  createNote(e) {
    console.log(universityData.currentUserID);
    var ourNewPost = {
      ...
      "status": "publish",
      "author": universityData.currentUserID //
    };
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      beforeSend: xhr => {
        xhr.setRequestHeader("X-WP-Nonce", universityData.nonce);
...
class Search {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).off("keydown").on("keydown", this.keyPressDispatcher.bind(this));
